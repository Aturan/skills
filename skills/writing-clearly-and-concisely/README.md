...
A skill that routes English and Chinese prose through the right writing rules, producing clearer, stronger, more professional text while avoiding common AI writing patterns.

## Purpose

This skill helps you write better prose for human readers. It draws from four sources:
...
3. **Chinese writing route** - Inline rules in `SKILL.md` for clear, concise Chinese expression
4. **Chinese typography guide** - Chinese/English spacing, punctuation, casing, links, numbers, and units
...
2. **Route by language** - English, Chinese, or bilingual
3. **Apply the matching rules** - Strunk for English, the inline Chinese route for Chinese
4. **Use typography rules for Chinese docs** - `chinese-documentation-guide.md`
5. **Avoid AI patterns** - no puffery, no empty phrases, no promotional adjectives
...
|---------|------|--------|---------|
| English grammar & punctuation | `02-elementary-rules-of-usage.md` | ~2,500 | Comma rules, possessives, sentence structure |
| English composition | `03-elementary-principles-of-composition.md` | ~4,500 | Active voice, concision, paragraph structure |
| English formatting | `04-a-few-matters-of-form.md` | ~1,000 | Headings, quotations, formatting conventions |
| English word choice | `05-words-and-expressions-commonly-misused.md` | ~4,000 | Common errors, word selection |
| Chinese typography | `chinese-documentation-guide.md` | ~2,000 | Chinese/English spacing, punctuation, casing, links, numbers, units |
...
6. **For Chinese, preserve facts first** - Then cut filler, make actions concrete, and apply typography rules
7. **Load reference files sparingly** - English usually needs only `03-elementary-principles-of-composition.md`; Chinese typography needs `chinese-documentation-guide.md`
...
writing-clearly-and-concisely/
  ...
  README.md                # This file
  chinese-documentation-guide.md
